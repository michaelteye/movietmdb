...
const FetchLatestTvData = async()=>{
    ...
    const uri = 'https://api.themoviedb.org/3/tv/on_the_air?language=en-US&page=1'
    const options = {
        method: 'GET',
        headers: {
...
const FetchLatestTvQuery = ()=>{
    return useQuery('lastest', FetchLatestTvData)
}
export default FetchLatestTvQuery